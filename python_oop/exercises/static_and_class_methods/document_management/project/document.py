...
class Document:
    def __init__(self, d_id : int , category_id : int , topic_id : int, file_name : str):
        self.id = d_id
    ...
    @classmethod
    def from_instances(cls, d_id: int, category : Category, topic : Topic, file_name: str ):
        return cls(d_id, category.id, topic.id , file_name)
